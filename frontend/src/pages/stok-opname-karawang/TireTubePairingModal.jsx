...
// Modal "Kelola Master Tire-Tube" — dipanggil dari dalam halaman Transfer
// Plan (bukan halaman/menu terpisah lagi). Isinya CRUD + import Excel buat
// master pasangan Tire (tubetype) <-> Tube, yang dipakai Transfer Plan buat
// auto-nambahin tube pasangan tiap kali tire masuk trip (qty 1:1).
...
// onChanged: dipanggil tiap ada data yang berubah (tambah/edit/hapus/import)
// biar TransferPlanPage bisa refresh master pasangan yang lagi dipakai.
    ...
    try {
      ...
      await Swal.fire({
        ...
        text:
          ...
          "Data pasangan Tire-Tube berhasil diimport.",
        timer: 5000,
